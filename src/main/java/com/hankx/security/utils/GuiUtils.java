...
import com.hankx.security.controller.MainController;
...
import static com.hankx.security.utils.WTUtils.unchecked;
...
public class GuiUtils {
    ...
    public static void msgAlert(Throwable t) {
        t.printStackTrace();
     ...
     */
    public static void handleExceptionsOnThisThread() {
        Thread.currentThread().setUncaughtExceptionHandler((thread, exception) -> {
            GuiUtils.msgAlert(Throwables.getRootCause(exception));
        });
    }
    ...
    public static URL getResource(String name) {
        if (false)
            return unchecked(() -> new URL("file:///D:/gitrepo/practice/pwd-manager/src/main/java/com/hankx/" + name));
        else
